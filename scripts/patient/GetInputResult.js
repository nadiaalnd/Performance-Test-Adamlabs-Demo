...
const GET_ENDPOINTS_INPUT_HASIL_PEMERIKSAAN_PASIEN = [
    ...
    '/inputhasil/pemeriksaan_pasien_input_hasil/read?no_lab=W01/240711/0001&page=0&page_size=2&kode_rs=W01&kode_lab=LAB_SMC'
];

export function getDataInputHasilPemeriksaanPasien() {
